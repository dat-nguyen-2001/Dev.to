...
const getLikedArticles = async() => {
    await axios.get('http://localhost:4000/likes', {headers: {Authorization: `Bearer ${sessionStorage.getItem('accessToken')}`}})
}

const usersApi = {getUserInfo, signIn, signUp, changeProfilePicture, likeArticle, getLikedArticles}
