                        ...
                        <div className='md:px-10 flex flex-col space-y-5'>
                            ...
                            <div className='flex space-x-2'>
                                ...
                                <div className='w-full flex flex-col space-y-2 items-left'>
                                    ...
                                    <button type='submit' className='commentSubmit w-[100px] py-2 cursor-pointer rounded-md bg-blue-600 hover:bg-blue-800 text-white front-semibold text-[1.2em]'>Submit</button>
                                </div>
                            </div>
                            {comments.length ?
                                <div>
