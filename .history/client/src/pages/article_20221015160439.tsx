                            ...
                            {comments.length ?
                                <div>
                                    {comments.map(comment => (
                                        <div className='flex space-x-2'>
                                            <div className='w-8 h-8 rounded-full cursor-pointer'>
                                                <img src={comment.user.profile_? curUser.profile_pic : 'https://www.transparentpng.com/thumb/user/gray-user-profile-icon-png-fP8Q1P.png'} className='rounded-full' />
                                            </div>
                                            <div className='w-full '>
                                                <textarea placeholder='Add to the discussion . . .' className='w-full h-[100px] px-3 pt-2 border-[#e5e5e5] border-[1px] rounded-md' />
                                            </div>
