                        ...
                        <div className='md:px-10 flex flex-col space-y-5'>
                            ...
                            <div className='flex space-x-2'>
                                ...
                                <form className='w-full flex flex-col space-y-2 items-left'>
                                    <textarea {...register("content", { required: true })} placeholder='Add to the discussion . . .' className='commentWrapper w-full h-[100px] px-3 pt-2 border-[#e5e5e5] border-[1px] rounded-md' />
                                    <button onClick={handleSubmit(onSubmit)} type='submit' className='hidden commentSubmit w-[100px] py-2 cursor-pointer rounded-md bg-blue-600 hover:bg-blue-800 text-white front-semibold text-[1.2em]'>Submit</button>
                                </form>
                            </div>
                            {comments.length ?
                                <div>
