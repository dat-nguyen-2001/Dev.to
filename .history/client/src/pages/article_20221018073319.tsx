                        ...
                        <div className='md:px-10 flex flex-col space-y-5'>
                            ...
                            <div className='flex space-x-2'>
                                ...
                                <form className='w-full flex flex-col space-y-2 items-left'>
                                    <textarea {...register("content", { required: true })} id='comment' placeholder='Add to the discussion . . .' className='commentWrapper w-full h-[100px] px-3 pt-2 border-[#e5e5e5] border-[1px] rounded-md' />
