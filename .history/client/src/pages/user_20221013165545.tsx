...
const { getUserInfo, changeProfilePicture, getLikedArticles } = usersApi
...
function User() {
  ...
  //Handle preview and upload image to Cloudinary
  ...
  // Handle change profile image, reload to update
  useEffect(() => {
    if (url === "") return;
