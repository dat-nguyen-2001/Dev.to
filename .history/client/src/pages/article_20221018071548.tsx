                    ...
                    <div className='mt-[-20px] pt-5 bg-white flex flex-col space-y-3 px-3 md:mt-0 rounded-lg md:mr-5 pb-10 lg:basis-[70%]'>
                        ...
                        <div className='md:px-10 flex flex-col space-y-5'>
                            ...
                            <div className='flex space-x-2'>
                                ...
                                <div className='w-full flex flex-col space-y-2 items-left'>
                                    <textarea placeholder='Add to the discussion . . .' className='commentWrapper w-full h-[100px] px-3 pt-2 border-[#e5e5e5] border-[1px] rounded-md' />
                                    <button type='submit' className='commentWrapper:hover:bg-white w-[100px] py-2 cursor-pointer rounded-md bg-blue-600 hover:bg-blue-800 text-white front-semibold text-[1.2em]'>Submit</button>
                                </div>
                            </div>
                            {comments.length ?
                                <div>
