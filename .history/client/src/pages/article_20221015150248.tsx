                    ...
                    <div className='mt-[-20px] pt-5 bg-white flex flex-col space-y-3 px-3 md:mt-0 rounded-lg md:mr-5 pb-10 lg:basis-[70%]'>
                        ...
                        <div className='md:px-10 flex flex-col space-y-5'>
                            ...
                            <div className='flex space-x-2'>
                                <div className='w-8 h-8 rounded-full cursor-pointer'>
                                    <img src={curUser !== null .profile_pic ? curUser.profile_pic : 'https://www.transparentpng.com/thumb/user/gray-user-profile-icon-png-fP8Q1P.png'} className='rounded-full' />
                                </div>
