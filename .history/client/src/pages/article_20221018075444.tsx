        ...
        <Layout title={title}>
            {article !== undefined &&
                <div className='flex lg:px-10 2xl:px-32'>
                    ...
                    {/* // Content wrapper */}
                    <div className='w-full over mt-[-20px] pt-5 bg-white flex flex-col space-y-3 px-3 md:mt-0 rounded-lg md:mr-5 pb-10 lg:basis-[70%]'>
                        {article.coverImage !== "" && <img src={article.coverImage} className="border-b-[1px] w-auto" />}
