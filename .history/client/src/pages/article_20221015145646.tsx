...
const ArticlePage = () => {
    ...
    useEffect(() => {
        ...
        getUserInfo(curUsername).then(data => setCurUser(data.data[0])).then(() => console.log('Current User:', curUser))
    ...
    }, []) //trigger again when article finished loaded, just we could get the article.id
